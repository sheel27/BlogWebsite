...
const Login = ({ isUserAuthenticated }) => {
    ...
    const imageURL = 'https://openclipart.org/image/2400px/svg_to_png/213221/Blog-icon.png';
    ...
    return (
        <Component>
            <Box>
            <h1 style={{textAlign: "center", margintop: "60px", marginBottom: "-21px"}}>Blog - Code to Help</h1>
